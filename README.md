...
To update the database use this command from the Web project folder (replace `Acme.Demo` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Acme.Demo.Infrastructure/Acme.Demo.Infrastructure.csproj -s Acme.Demo.Web.csproj
```
